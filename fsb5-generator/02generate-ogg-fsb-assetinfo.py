...
# Path to input folder containing .ogg files
input_folder = './Input'
...
def process_file(input_file, output_dir):
    ...
    # Find the corresponding .resource file (assumes .resource file has the same base name as the .ogg file)
...
# Process all .ogg files in the input folder
